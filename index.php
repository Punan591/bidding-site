...
<html lang="en">
    ...
    <body id="page-top" style="background-color:#141414;">
        <!-- Navigation-->
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav" style="background-color:black;">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="./"><img src="assets/img/logo.png" alt="Logo" height="40px" width="180px"></a>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5" style="background-color:black;">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2020 - <?php echo $_SESSION['system']['name'] ?> | <a href="" target="_blank">ShirshoBidding</a></div></div>
        </footer>
