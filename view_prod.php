...
<div class="container-fluid">
	...
	<div class="col-md-12">
		<button class="btn btn-primary btn-block btn-sm" type="button" id="bid">Bid</button>
		 <button type="button" class="btn btn-primary btn-block btn-sm mt-2" id="pay_now">Pay Now</button>
	</div>
	<div id="bid-frm">
		<div class="col-md-12">
			<form id="manage-bid">
...
<script>
    ...
    $('#pay_now').click(function() {
        ...
        var isLoggedIn = '<?php echo isset($_SESSION['login_id']) ? 1 : '' ?>';
        ...
        var paymentAmount = 100; // Replace with actual bidding amount
        var paypalUrl = "https://www.sandbox.paypal.com/cgi-bin/webscr" +
            "?cmd=_xclick" +
            "&business=merchant_email@example.com" + // Replace with merchant's verified PayPal email
            "&item_name=Bidding Payment" +
            "&amount=" + paymentAmount +
            "&currency_code=USD" +
            "&return=http://yourwebsite.com/payment_success.php" + // Replace with your success URL
            "&cancel_return=http://yourwebsite.com/payment_cancel.php"; // Replace with your cancel URL
